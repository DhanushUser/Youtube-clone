...
const PlayVideo = () => {
    ...
    const fetVideoData = async () =>{
        ...
        await fetch(videoDetails_url)
            ...
            .catch(error => console.error('Error fetching video data:', error)); // Handle fetch error
    }

    const fetchOtherData = async ()=>{
        // Only fetch other data if apiData is not null
        if (!apiData) return;
        ...
        try {
            ...
            const commentDataJson = await commentResponse.json();
            setCommentData(commentDataJson.items);
        } catch (error) {
            console.error('Error fetching other data:', error); // Handle fetch error
        }
    }
    ...
    <div className='play-video'>
        ...
        <div className="play-video-info">
            ...
            <div>
                ...
                <span><img src={dislike} alt="" />{/* Dislike count */}</span>
